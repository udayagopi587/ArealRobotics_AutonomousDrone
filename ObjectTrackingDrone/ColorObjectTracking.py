# -*- coding: utf-8 -*-
"""
Created on Sat Feb 26 20:21:06 2022
...
cv2.createTrackbar("HUE Max","HSV",75,179,empty)
cv2.createTrackbar("SAT Min","HSV",105,255,empty)
cv2.createTrackbar("SAT Max","HSV",245,255,empty)
cv2.createTrackbar("VALUE Min","HSV",80,255,empty)
cv2.createTrackbar("VALUE Max","HSV",140,255,empty)

cv2.namedWindow("Parameters")
cv2.resizeWindow("Parameters",640,240)
cv2.createTrackbar("Threshold1","Parameters",166,255,empty)
cv2.createTrackbar("Threshold2","Parameters",171,255,empty)
cv2.createTrackbar("Area","Parameters",4410,30000,empty)
...
fbRange = [6200, 6800]
pError = 0
def trackObj(tello, center, area, w, pid, pError):
    fb = 0
...
while True:
    ...
    # loop over the set of tracked points
        ...
        pError = trackObj(mytello, center, area, width, pid, pError)
    if startCounter == 0:
        mytello.takeoff()
        startCounter = 1
